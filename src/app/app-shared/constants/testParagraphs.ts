...
export const easyParagraph: ITestParagraph = {
  Normal: [
    ...
    'transforming familiar landscapes into scenes of',
    'serene beauty. Leaves rustle softly in a gentle',
    'breeze, and the distant hoot of an owl',
    'adds a touch of mystery to the tranquil',
    'atmosphere. This is a time when thoughts drift',
    'effortlessly, and the worries of the day fade',
    'into the background.',
    'The night, with its calming presence, offers',
    'a moment of reflection and peace, inviting',
    'all who are awake to bask in its quiet splendor.',
    'The gentle hum of the city awakened me early',
    'this morning, a soundscape composed of a',
    'distant car horns, the occasional chirp of birds',
    'and the ever-present murmur of human activity.',
    'As I stepped outside, the air was cool',
    "and refreshing, a reminder that summer's",
    ...
    'Walking down the familiar streets, I marveled',
    'at the blend of nature and urban life, where',
    ...
    'thrived even in the most unexpected places.',
    'This brief morning reverie filled me with a',
    'sense of calm and readiness to face whatever',
